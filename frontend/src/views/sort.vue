    ...
    export default {
        ...
        data() {
            return {
                ...
                sort_type: "",
                table_data: [],
                field_affi_title: [["paperCount","Paper Count"],["citationCount","Citation Count"] , ["heat","Activity"]],
                conf_title: [["paperCount","Paper Count"],["citationCount","Citation Count"] , ["heat","Activity"]],
                author_title: [["paperCount","Paper Count"],["citationCount","Citation Count"] , ["heat","Activity"], ["h_index","H-index"], ["cited_rate","CitedRate"]],
                span_len: 22,
